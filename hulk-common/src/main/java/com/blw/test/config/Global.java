 ...
 */
package com.blw.test.config;

import com.blw.test.utils.PropertiesLoader;
...
public class Global {
	...
	public static String NEW_USER_PASSWORD="123456";

	public static String t = String.valueOf(Calendar.getInstance().getTimeInMillis());
	...
	public static String getRequestFilePath(){
		return getConfig("requestFilePath");
	}
